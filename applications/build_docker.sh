...
docker build --build-arg APP=simpledag --build-arg CONTAINER=1 -f ./simpledag/simpledagDockerfile -t simpledag:container1 .
docker build --build-arg APP=simpledag --build-arg CONTAINER=2 -f ./simpledag/simpledagDockerfile -t simpledag:container2 .
