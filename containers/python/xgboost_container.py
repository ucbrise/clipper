...
class XGBoostContainer(rpc.ModelContainerBase):
    def __init__(self, path, input_type):
        ...
        self.model = load_xgboost_model(path)
...
if __name__ == "__main__":
    print("Starting XGBoost container")
    try:
    ...
    print("Initializing XGBoost function container")
    sys.stdout.flush()
    sys.stderr.flush()
