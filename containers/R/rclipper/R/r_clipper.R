serve_model = function(name, version, ip, port, fn, sample_input) {
  model_input_class = class(sample_input)
  ...
  if(model_input_class == "numeric") {
    .Call("serve_numeric_vector_model",
          ...
          pred_fn,
          package="rclipper")
  } else if(model_input_class == "integer") {
    ...
    .Call("serve_raw_vector_model",
          ...
          pred_fn,
          package="rclipper")
  } else if(model_input_class %in% serialized_classes) {
    deserialize_pred_fn = function(input) {
      ...
      if(input_class != model_input_class) {
