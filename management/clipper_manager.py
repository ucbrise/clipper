...
DOCKER_COMPOSE_DICT = {
    ...
    'services': {
        'mgmt_frontend': {
            ...
            'depends_on': ['redis'],
            'image': 'clipper/management_frontend:test', # TODO: change back to latest before merge
        ...
        'query_frontend': {
            ...
            'depends_on': [
                'redis',
                'mgmt_frontend'],
            'image': 'clipper/query_frontend:test', # TODO: change back to latest before merge
            'ports': [
