...
inline std::istream&
operator>>(std::istream& is, cmsys::IOStreamSLL& value)
{
...
inline std::istream&
operator>>(std::istream& is, cmsys::IOStreamULL& value)
{
  return cmsys::IOStreamScan(is, value);
}
#  endif
...
inline std::ostream&
operator<<(std::ostream& os, cmsys::IOStreamSLL value)
{
...
inline std::ostream&
operator<<(std::ostream& os, cmsys::IOStreamULL value)
{
  return cmsys::IOStreamPrint(os, value);
}
#  endif
