...
def save_python_function(name, func):
    ...
    #         "See http://docs.clipper.ai/en/release-0.2/index.html#pure-python-functions for "
    #         "more information."
    #     )
    #
...
#                     logger.warning(
#                         ("Could not identify the location of the root package {package} for "
#                         "module {module}. Will not supply it to the container.").
#                         format(
